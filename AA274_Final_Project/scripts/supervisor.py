...
class Supervisor:
    ...
    def __init__(self):
        ...
        self.lm_publisher = rospy.Publisher('/lm_loc', Pose2D, queue_size = 10)
        # subscribers
        # stop sign detector
    ...
    def pub_lm(self):
        """ Publishes location of landmark """

        pose_lm_msg = Pose2D()
        pose_lm_msg.x = self.x
        pose_lm_msg.y = self.y
        pose_lm_msg.theta = self.theta

        self.lm_publisher.publish(pose_lm_msg)
        self.mode = Mode.NAV
